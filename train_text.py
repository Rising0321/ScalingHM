...
1 GPU:
CUDA_VISIBLE_DEVICES=3 python train_text.py --write_tensors=0 --num_iterations=50 --sequence_length=1024 --compile=1 --tensorcores=1 --dtype=bfloat16
you can also turn on flash-attention by appending --flash=1
4 GPU:
CUDA_VISIBLE_DEVICES=0,3 python3 -m torch.distributed.launch --standalone --nproc_per_node=2 train_text.py --write_tensors=0 --num_iterations=50 --sequence_length=1024 --compile=0 --tensorcores=1 --dtype=bfloat16

CUDA_VISIBLE_DEVICES=3 torchrun --standalone --nproc_per_node=1 train_text.py --write_tensors=0 --num_iterations=250000 --sequence_length=1024 --compile=0 --tensorcores=1 --dtype=bfloat16
"""
...
# git clone git@git.devops.cmit.cloud:20003/xydmxgjjsg.xydmxgjjsg/trajgpt.git
if __name__ == "__main__":
    ...
    parser.add_argument("--input_bin", type=str, default="data/fineWeb/fineweb10B/*_train_*.bin",
                        help="input .bin to train on")
    parser.add_argument("--input_val_bin", type=str, default="data/fineWeb/fineweb10B/*_val_*.bin",
    ...
    parser.add_argument("--total_batch_size", type=int, default=4096,
    ...
    tokens_per_fwdbwd = B * T * ddp_world_size  # 4*1024*1 = 4096
